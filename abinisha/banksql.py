...
def customerloginpage(data,win):
    ...
    label_font=font.Font(weight="bold",family="Times New Roman",size=20)
    f2=Label(win,text="@ABI",font=label_font,bg="blue",fg="white")
...
def custreg(win):
    ...
    label_font=font.Font(weight="bold",family="Times New Roman",size=20)
    f=Label(win,text="ICICI BANK",font=label_font,bg="blue",fg="white")
    ...
    b3.place(relx=0.04,rely=0.6)
    def insert():
        connection=mysql.connect(host="localhost",user="root",password="livewire",database="bank")
        cursor=connection.cursor()
        s="insert into v1 (Name,AadharNo,PanNo,Contact,EmailId,Address)values(%s,%s,%s,%s,%s,%s)"
    ...
    def update():
        connection=mysql.connect(host="localhost",user="root",password="livewire",database="bank")
        cursor=connection.cursor()
        sql= "update v1 set AadharNo='"+str(e2.get())+"',PanNo='"+str(e3.get())+"',Contact='"+str(e4.get())+"',EmailId='"+str(e5.get())+"',Address='"+str(e6.get())+"' where Name='"+str(e1.get())+"'"
        cursor.execute(sql)
        connection.commit()  
    ...
    def delete():
        connection=mysql.connect(host="localhost",user="root",password="livewire",database="bank")
        cursor=connection.cursor()
        sql="DELETE From v1 WHERE Name='"+e1.get()+"'"
        cursor.execute(sql)
        connection.commit()
